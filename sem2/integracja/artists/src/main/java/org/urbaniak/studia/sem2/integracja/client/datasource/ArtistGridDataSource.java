...
public class ArtistGridDataSource extends GwtRpcDataSource {

    private static final String DISPATCHER_ARTIST_RPC = "../dispatcher/artist.rpc";

    public ArtistGridDataSource() {
